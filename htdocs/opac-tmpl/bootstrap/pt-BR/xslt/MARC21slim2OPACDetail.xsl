...
<xsl:stylesheet version="1.0"
 ...
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'">Livro</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'">
 <xsl:choose>
 <xsl:when test="substring($controlField008,22,1)!='m'">Recurso Contínuo</xsl:when>
 <xsl:otherwise>Série</xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'">Artigo</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'">Livro</xsl:when>
 <xsl:when test="$leader6='o'">Kit</xsl:when>
 <xsl:when test="$leader6='p'">Materiais mistos</xsl:when>
 <xsl:when test="$leader6='m'">Arquivos de computador</xsl:when>
 ...
 <h5 class="author">por <xsl:call-template name="showAuthor">
 ...
 <span class="results_summary volumes"><span class="label">Voumes: </span>
 <a>
 <xsl:choose>
 <xsl:when test="$UseControlNumber = '1' and marc:controlfield[@tag=001]">
 ...
 <xsl:text>Mostrar volumes</xsl:text>
 </a>
 </span>
 </xsl:if>
 ...
 <span class="label">Informações pessoais: </span>
 ...
 <span class="label">Número de relato: </span>
...
<!-- Image processing code added here, takes precedence over text links including y3z text -->
 ...
 <span class="label">Conteúdo incompleto:</span>
 </xsl:when>
 <xsl:when test="@ind1=2">
 <span class="label">Conteúdo parcial:</span>
 </xsl:when>
 <xsl:otherwise>
 ...
 <xsl:when test="@ind1=1"><xsl:text>Artigo de revisão: </xsl:text></xsl:when>
 <xsl:when test="@ind1=2"><xsl:text>Escopo e conteúdo: </xsl:text></xsl:when>
 <xsl:when test="@ind1=3"><xsl:text>Resumo: </xsl:text></xsl:when>
 <xsl:when test="@ind1=4"><xsl:text>Conselho sobre conteúdo: </xsl:text></xsl:when>
 <xsl:otherwise><xsl:text>Resumo: </xsl:text></xsl:otherwise>
 </xsl:choose>
 </span>
 <xsl:call-template name="subfieldSelect">
 ...
 <span class="results_summary holdings_note"><span class="label">Nota dos exemplares: </span>
 ...
 <span class="label">Substitui em parte:</span>
 </xsl:when>
 <xsl:when test="@ind2=4">
 <span class="label">Formada pela união: ... e: ...</span>
 </xsl:when>
 <xsl:when test="@ind2=5">
 <span class="label">Absorvido:</span>
 </xsl:when>
 <xsl:when test="@ind2=6">
 <span class="label">Absorvido em parte:</span>
 </xsl:when>
 ...
 <xsl:when test="@ind2=2">
 <span class="label">Substituído por:</span>
 </xsl:when>
 <xsl:when test="@ind2=3">
 <span class="label">Substituído em parte por:</span>
 </xsl:when>
 <xsl:when test="@ind2=4">
 <span class="label">Absorvido por:</span>
 </xsl:when>
 <xsl:when test="@ind2=5">
 <span class="label">Absorvido em parte por:</span>
 </xsl:when>
 <xsl:when test="@ind2=6">
 <span class="label">Dividir em .. e ...:</span>
 </xsl:when>
 <xsl:when test="@ind2=7">
 <span class="label">Fundiu-se com ... para formar ...</span>
 </xsl:when>
 <xsl:when test="@ind2=8">
 <span class="label">Alterado de volta para:</span>
 </xsl:when>
 </xsl:choose>
 <xsl:text> </xsl:text>
 ...
 <xsl:otherwise><xsl:attribute name="property">colaborador</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
